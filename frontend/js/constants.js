const contractAddress = "0xC24CB2D57d2A48938C78c4c134362E9494eC130C"; //Replace with your own contract address
const chain = 'polygon'; // rinkeby or polygon

const welcome_h1 = "Welcome to the Idiot Boys Club NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The Idiot Boys Club NFT Project is a decentralized, .';
